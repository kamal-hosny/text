...
const SideHeader = () => {
    return (
         <div className="w-[265px] bg-[#F8F8F8] h-screen fixed top-0 right-0 space-y-4 py-10 px-5 overflow-y-auto">
            <DLogo />
            <button  className='bg-black cursor-pointer text-white font-semibold  items-center justify-center p-2.5 text-[12px] h-[38px] w-[125px] rounded-full flex gap-2'>زيـــارة المــوقع
